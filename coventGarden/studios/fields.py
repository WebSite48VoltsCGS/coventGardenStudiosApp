...
MODEL_GROUP_PHONE = models.CharField(max_length=LENGTH_PHONE, verbose_name=LABEL_PHONE, validators=[phone_validator], null=True)
MODEL_MEMBERS = models.IntegerField(validators=[MinValueValidator(1), MaxValueValidator(20)], verbose_name=LABEL_MEMBERS, default=1, null=True)
